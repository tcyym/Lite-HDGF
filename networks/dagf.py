...
#         # self.args = args
#         # self.num_pyramid = num_pyramid
#         self.head = common.Head(num_features=num_features, act=act, norm=norm, guide_channels=2)
#         self.head = common.Head(num_features=num_features, act=act, norm=norm, in_channels=2)
...
#         lr_feature1, guide_feature1 = self.head(x_waves, rgb)
#         # depth_features, guide_features = [lr_feature], [guide_feature]
#         # for num_p in range(self.num_pyramid - 1):
#         #     lr_feature = self.depth_pyramid[num_p](lr_feature)
#         #     depth_features.append(lr_feature)
...
#         out = torch.max(out1, out2) + self.gamma*lr
#
#         # ret_feature.append(lr_input)
#
#         # out = []
